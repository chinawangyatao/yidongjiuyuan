...
import { addGroup, editGroup, getGroupID, getTeam } from '@/api/count'
...
const getColumns = async () => {
  ...
  // const res = await getTeam(733);//改这里
  if (res.code === 200) {
...
<template>
  <div class="container">
    <!--    <TopMenu :is-back="true" :menu-title="flag === '1' ? '修改方案组' : '新增方案组'">    </TopMenu> -->
    <van-form @submit="onSubmit">
      <van-field
        v-model="formData.group" label-align="top" label="方案组：" placeholder="请输入方案组"

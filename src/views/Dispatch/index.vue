...
import { getGroup, getInfo, getTeam, updataStatus, getGroupID } from "@/api/count";
...
const getData = async params => {
  ...
  if (res.code === 200) dataInfo.data = res.data;
};
getData(id);
...
<template>
  <div class="container">
    <TopMenu :is-back="true" menu-title="上传信息">
      <van-form>
        <van-field v-model="formGroup.group" label-align="top" is-link readonly label="方案组：" placeholder="请选择方案组"
